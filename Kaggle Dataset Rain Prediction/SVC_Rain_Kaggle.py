...
classifier=SVC(C=10,kernel='rbf',gamma=0.02,random_state=0)
...
"""**Due to computational limitations K-FOLD CROSS VALIDATION and GRID SEARCH WERE NOT ABLE TO RUN PROPERLY"""
...
parameters=[{'C':[1,10,100],'kernel':['linear']},{'C':[1,10,100],'kernel':['rbf'],'gamma':[0.5,0.1,0.01,0.02,0.03,0.05,0.001]}]
